...
class OptimizerPara:
    SGD      = {"switch": True,  "momentum": 0.9, "dampening": 0, "weightDecay": 5e-4, "nesterov": False}
    Adam     = {"switch": False, "betas": [0.9, 0.999], "eps": 1e-8, "weightDecay": 5e-4, "amsgrad": False}
...
class SchedulerPara:
    stepLR            = {"switch": True,  "stepSize": 50, "gamma": 0.1}
